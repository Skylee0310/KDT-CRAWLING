...
html = urlopen('https://m.datanews.co.kr/m/m_article.html?no=131382')
bs = BeautifulSoup(html, 'html.parser')
article = bs.find('div', {'id':'news_body_area'}).find_all('div')
#print(article)
...
def make_wordcloud(title_list, stopwords, word_count):
    ...
    img_mask = np.array(Image.open('protect.png'))
