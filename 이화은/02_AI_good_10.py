...
html = urlopen('https://www.aitimes.com/news/articleView.html?idxno=129809')
bs = BeautifulSoup(html, 'html.parser')
article = bs.find('article', {'id':'article-view-content-div'}).find_all('p')
#print(article)
...
def make_wordcloud(title_list, stopwords, word_count):
    ...
    img_mask = np.array(Image.open('square.png'))
