...
html = urlopen('https://www.dailian.co.kr/news/view/1326856/?sc=Naver')
bs = BeautifulSoup(html, 'html.parser')
article = bs.find('div', {'class':'article'}).find_all('p')
#print(article)
...
def make_wordcloud(title_list, stopwords, word_count):
    ...
    img_mask = np.array(Image.open('financial.png'))
